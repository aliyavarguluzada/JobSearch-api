...
namespace JobSearch.Infrastructure.Migrations
{
    ...
    [Migration("20240714085107_changed Relation between Phone Operator nad OperatorCode")]
    partial class changedRelationbetweenPhoneOperatornadOperatorCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobSearch.Domain.Entities.Phone", b =>
                {
                    b.HasOne("JobSearch.Domain.Entities.OperatorCode", "OperatorCode")
                        .WithMany()
                        .HasForeignKey("OperatorCodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("OperatorCode");
                });
